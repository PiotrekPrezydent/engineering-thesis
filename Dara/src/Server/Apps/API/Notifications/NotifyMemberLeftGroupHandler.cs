...
public class NotifyMemberLeftGroupHandler : IHubNotificationHandler<MemberLeftGroupIntegrationEvent>
{
    ...
    public NotifyMemberLeftGroupHandler(IGroupsModule groupModule, IProfilesModule profilesModule, IHubContext<AppHub, IAppHubClient> context)
    {
