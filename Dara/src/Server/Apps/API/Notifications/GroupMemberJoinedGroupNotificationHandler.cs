...
//
// public class GroupMemberJoinedGroupNotificationHandler : IHubNotificationHandler<NewMemberJoinedGroupIntegrationEvent>
// {
...
//
//     public GroupMemberJoinedGroupNotificationHandler(IGroupModule groupModule, IProfilesModule profilesModule, IHubContext<AppHub, IAppHubClient> context)
//     {
...
//                 new GroupMemberSnapshot(e.Id, e.Name))
//                 .ToList()));
//         
...
//             new GroupMemberSnapshot(clientProfile.Id, clientProfile.Name));
//         
