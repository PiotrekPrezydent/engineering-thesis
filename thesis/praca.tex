...
\author{Piotr Prezydent}
\shortauthor{P. Prezydent}
\noAlbum{131497}

\titlePL{Projekt i implementacja rozproszonego asystenta AI z modularną architekturą wtyczek}
\titleEN{}

\shorttitlePL{Asystent AI}
\shorttitleEN{}

\thesistype{Praca inżynierska}

\thesisDone{Praca wykonana pod kierunkiem}
\supervisor{dr inż. Przemysław Pardel}
